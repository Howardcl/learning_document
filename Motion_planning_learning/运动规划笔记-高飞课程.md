...
关于这种问题的非线性优化方法，都有现场的软件库可以用的,不用自己写。比如Ceres，NLopt。一般做Slam的用Ceres很多，做planning的用NLopt用的多。
...
分成两种情况。Independent Game & Dependent Game
